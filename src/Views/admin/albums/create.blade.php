                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control" name="artist_id">
                                            ...
                                            @foreach($artists as $key=>$artist)
                                                <option value="{{ $key }}" {{ old('artist_id') == $key ? 'selected="selected"' : '' }} >
                                                    {!! $artist->name !!}
                                                </option>
                                            @endforeach
                                        </select>

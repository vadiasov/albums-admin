                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control" name="artist_id">
                                            ...
                                            @foreach($artists as $key=>$artist)
                                                <option value="{{ $key }}" {{ (old('artist_id') == $key or $album->artist_id == $key) ? 'selected="selected"' : '' }} >
                                                    {!! $artist->name !!}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-sm-9">
                                        <div class="input-group date">
                                            ...
                                            <input type="text" class="form-control pull-right" id="datepicker"
                                                   ...
                                                   value="{{ old('release_date') ? old('release_date') : $album->release_date }}">
                                        </div>
                                    </div>
                                    <!-- /.input group -->
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="price"
                                               placeholder="000.00"
                                               value="{{ old('price') ? old('price') : $album->price }}">
                                    </div>
                                </div>
                                        ...
                                        <div>
                                            <label>
                                                <input type="radio" name="free" id="optionsRadios1" value="0"
                                                       ...
                                                       @else ($album->free === '0') checked="checked" @endif >
                                                Free
                                            </label>
                                        </div>
                                        <div>
                                            <label>
                                                <input type="radio" name="free" id="optionsRadios2" value="1"
                                                       ...
                                                       @else ($album->free === '1') checked="checked" @endif >
                                                Paid
                                            </label>
                                        </div>
                                    </div>
                                        ...
                                        <div>
                                            <label>
                                                <input type="radio" name="donate" id="optionsRadios3" value="0"
                                                       ...
                                                       @else ($album->donate === '0') checked="checked" @endif >
                                                Yes
                                            </label>
                                        </div>
                                        <div>
                                            <label>
                                                <input type="radio" name="donate" id="optionsRadios4" value="1"
                                                       ...
                                                       @else ($album->donate === '1') checked="checked" @endif >
                                                No
                                            </label>
                                        </div>
                                    </div>
